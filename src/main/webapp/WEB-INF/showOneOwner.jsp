        ...
        <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <%@ page isErrorPage="true" %>
                    ...
                    <head>
                        <meta charset="UTF-8" />
                        <title>Craig Burke - Candy - Show One Owner</title>
                        <!-- Bootstrap -->
                        <!-- CSS only -->
                    ...
                    <body>
                        ...
                        <div class="container text-center mt-5">
                            ...
                            <div>
                                <h1 class="bg-primary text-light ps-5 text-start">Owner Details</h1>
                            </div>
                            ...
                            <div class="container w-75">
                                ...
                                <div data-bs-spy="scroll" data-bs-target="#navbar-scrollspy" data-bs-offset="0"
                                    ...
                                    <table class="table table-striped p-2 border border-2">
                                        <tbody>
                                            <c:forEach var="candy" items="${owner.candys}">
                                                <tr>
